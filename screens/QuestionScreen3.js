...
const QuestionScreen3 = ({ navigation }) => {
  ...
  const handleNextPress = () => {
    navigation.navigate("Question4", { weight: currentWeight });
  };
  ...
  return (
    <View style={styles.container}>
      <View style={{ position: "absolute" }}>
        <Image
          source={require("@/assets/images/QuestionsPage/Questions_Background_3.png")}
          resizeMode="contain"
      ...
      <View>
        ...
        <Text style={styles.questionHeaderText2}>current weight?</Text>
      </View>
