...
const QuestionScreen4 = ({ navigation }) => {
  ...
  const handleNextPress = () => {
    navigation.navigate("Question5", { height: currentHeight });
  };
  ...
  return (
    <View style={styles.container}>
      <View style={{ position: "absolute" }}>
        <Image
          source={require("@/assets/images/QuestionsPage/Questions_Background_4.png")}
          resizeMode="contain"
      ...
      {/* Question Text */}
      <View>
        <Text style={styles.questionHeaderText}>What is your</Text>

        <Text style={styles.questionHeaderText2}>current height?</Text>
      </View>
